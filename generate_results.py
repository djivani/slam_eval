...
import rosbag
print("checking if bag has readable topics")
bag_handle = rosbag.Bag("/media/devavratjivani/New Volume/Ubuntu18_ExtendedStorage/results_slam/bags_stereo/2021-03-25-15-57-38.bag",'r')
...
traj_est = file_interface.read_bag_trajectory(bag_handle, "/tf:map.camera_link")
